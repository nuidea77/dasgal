...
// Facing the camera: left and right joints must actually differ in x, or the
// figure collapses to a single vertical line.
const STAND: number[][] = [
  [0.5, 0.11], [0.52, 0.1], [0.48, 0.1], [0.545, 0.115], [0.455, 0.115],
  [0.585, 0.26], [0.415, 0.26], [0.615, 0.4], [0.385, 0.4], [0.635, 0.53], [0.365, 0.53],
  [0.556, 0.545], [0.444, 0.545], [0.566, 0.735], [0.434, 0.735], [0.572, 0.925], [0.428, 0.925],
];
const SQUAT_DOWN: number[][] = [
  [0.5, 0.25], [0.52, 0.24], [0.48, 0.24], [0.545, 0.255], [0.455, 0.255],
  [0.595, 0.39], [0.405, 0.39], [0.645, 0.5], [0.355, 0.5], [0.66, 0.41], [0.34, 0.41],
  [0.572, 0.61], [0.428, 0.61], [0.63, 0.755], [0.37, 0.755], [0.585, 0.925], [0.415, 0.925],
];
